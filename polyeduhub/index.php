        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-4">PolyEduHub is a centralized platform for Polytechnic Malaysia students to access, share, and collaborate on educational resources.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-6">
                    <div class="stats-box">
                        ...
                        <div>Polytechnic Institutions</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p>A centralized platform for Polytechnic Malaysia students to access, share, and collaborate on educational resources.</p>
