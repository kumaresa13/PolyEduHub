            ...
            if (password_verify($password, $user['password'])) {
                ...
                if (isset($_POST['remember']) && $_POST['remember'] == 'on') {
                    try {
                        ...
                        $tableExists = $pdo->query("SHOW TABLES LIKE 'remember_me_tokens'")->rowCount() > 0;
                        ...
                        // If remember me functionality fails, log it but continue login
                        error_log("Remember me functionality failed: " . $e->getMessage());
                    }
                }
                ...
                try {
                    ...
                    // If activity logging fails, log it but continue login
